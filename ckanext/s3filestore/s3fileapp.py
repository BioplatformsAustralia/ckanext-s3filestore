...
class S3FileApp(DataApp):
    ...
    def update(self, force=False):
        self.s3_object.load()
        self.last_modified = time.mktime(obj.last_modified.timetuple())
        self.content_length = obj.content_length
        self.content_encoding = obj.content_encoding
    ...
    def get(self, environ, start_response):
        ...
        if is_head:
            return [b'']
        return obj.get(Range="bytes=%d-%d" % (lower, content_length))
